...
func (m *EventRegisterMapping) Reset()         { *m = EventRegisterMapping{} }
func (m *EventRegisterMapping) String() string { return proto.CompactTextString(m) }
...
func (m *EventRegisterMapping) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EventRegisterMapping) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EventRegisterMapping.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
...
func (m *EventRegisterMapping) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EventRegisterMapping.Merge(m, src)
}
func (m *EventRegisterMapping) XXX_Size() int {
	return m.Size()
}
func (m *EventRegisterMapping) XXX_DiscardUnknown() {
	xxx_messageInfo_EventRegisterMapping.DiscardUnknown(m)
}

var xxx_messageInfo_EventRegisterMapping proto.InternalMessageInfo

func (m *EventRegisterMapping) GetDenom() string {
	if m != nil {
		return m.Denom
	}
	return ""
...
func (m *EventRegisterMapping) GetErc20Address() string {
	if m != nil {
...
func init() {
	proto.RegisterType((*EventRegisterMapping)(nil), "cosmos.evm.erc20.v1.EventRegisterMapping")
...
var fileDescriptor_fb108440d0a34e58 = []byte{
	...
	,
}

func (m *EventRegisterMapping) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
...
func (m *EventRegisterMapping) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *EventRegisterMapping) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *EventRegisterMapping) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *EventRegisterMapping) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		if wireType == 4 {
			return fmt.Errorf("proto: EventRegisterMapping: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EventRegisterMapping: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
