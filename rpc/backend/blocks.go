...
func (b *Backend) formatTxReceipt(ethMsg *evmtypes.MsgEthereumTx, blockMsgs []*evmtypes.MsgEthereumTx, blockRes *cmtrpctypes.ResultBlockResults, blockHeaderHash string) (map[string]interface{}, error) {
